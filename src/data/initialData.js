...
export const INITIAL_USERS = [
  {
    ...
    publicLocality: "📍 Perungulam • Perunkulam Firka",
    isVerified: true,
  ...
  },
  {
    ...
    townPanchayat: "Sayalgudi Town Panchayat",
    villagePanchayat: null,
    locality: "Sayalgudi",
    adminType: "Town Panchayat",
    communityName: "Sayalgudi Community",
    publicLocality: "📍 Sayalgudi Town Panchayat",
    isVerified: true,
    isTrustedMember: true,
    overallRating: 4.6,
    reviewCount: 18,
  ...
  },
  {
    ...
    role: "Customer/Buyer",
    district: "Ramanathapuram",
    taluk: "Thiruvadanai Taluk",
    townPanchayat: "Tondi Town Panchayat",
    villagePanchayat: null,
    locality: "Tondi",
    adminType: "Town Panchayat",
    communityName: "Tondi Community",
    publicLocality: "📍 Tondi Town Panchayat",
    isVerified: true,
    isTrustedMember: true,
    overallRating: 4.9,
    reviewCount: 9,
...
export const INITIAL_ITEMS = [
  {
    ...
    distanceKm: 2.4,
    publicLocality: "📍 Perungulam • Perunkulam Firka",
    exactAddressHidden: "Opposite School, East Street, Perungulam",
...
export const INITIAL_DEALS = [
  {
    ...
    adminType: "Locality / Revenue Village",
    communityName: "Perungulam Community",
    agreedPickupLocation: "Perungulam East Street Ground",
...
export const PANCHAYAT_COMMUNITY_STATS = [
  {
    ...
    description: "Active local sharing community in Perungulam (Perunkulam Firka, Ramanathapuram Taluk). High trust rating for farm equipment, event electronics, and tools."
  },
  {
    communityName: "Paramakudi Municipality Community",
    locality: "Paramakudi Town",
  ...
  {
    communityName: "Pattinamkattan Village Panchayat Community",
    locality: "Pattinamkattan",
    taluk: "Ramanathapuram Taluk",
    revenueDivision: "Ramanathapuram",
    adminType: "Village Panchayat",
    isPanchayatVerified: true,
    ...
    activeNeeds: 5,
    averageRating: 4.8,
    topTags: ["Trusted Local", "As Described"],
    heroBanner: "https://images.unsplash.com/photo-1528728329032-2972f65dfb3f?auto=format&fit=crop&q=80&w=1000",
    description: "Pattinamkattan official Village Panchayat sharing network."
  },
  {
    communityName: "Devipattinam Coastal Village Panchayat Community",
  ...
  {
    communityName: "Kilakarai Municipality Community",
    locality: "Kilakarai",
    taluk: "Kilakarai Taluk",
    revenueDivision: "Ramanathapuram",
    adminType: "Municipality",
    municipality: "Kilakarai Municipality",
    isPanchayatVerified: false,
    villagePanchayat: null,
    activeMembers: 58,
    successfulDeals: 28,
...
export const INITIAL_CHAT_MESSAGES = [
  ...
  },
  {
    ...
    senderId: "u3",
    senderName: "Karthik V.",
    text: "Perungulam locality side pickup pannikkalama?",
    timestamp: "10:35 AM",
    type: "text"
  },
  {
    ...
    senderId: "u1",
    senderName: "Muthu Kumar",
    text: "Yes, East Street nearby pickup pannikkalam.",
    timestamp: "10:36 AM",
    type: "text"
  },
  {
